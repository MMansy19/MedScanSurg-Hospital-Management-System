function updateDoctors() {
  ...
  var surgeonData = {
    "Orthopedic Surgery": [
      { name: "Dr. Shaun Murphy", specialization: "Orthopedic Specialist", image: "doctor1.jpg" },
      { name: "Dr. Amr Safwat", specialization: "Orthopedic Specialist", image: "doctor2.jpg" },
      { name: "Dr. Reznik", specialization: "Orthopedic Specialist", image: "doctor3.jpg" },
    ],
    "Cardiovascular Surgery": [
      { name: "Dr. Brown", specialization: "Cardiovascular Specialist", image: "doctor4.jpg" },
      { name: "Dr. Davis", specialization: "Cardiovascular Specialist", image: "doctor5.jpg" },
      { name: "Dr. Miller", specialization: "Cardiovascular Specialist", image: "doctor6.jpg" },
    ],
    "Neurosurgery": [
      { name: "Dr. Steve", specialization: "Neurosurgery Specialist", image: "doctor7.jpg" },
      { name: "Dr. Menz", specialization: "Neurosurgery Specialist", image: "doctor8.jpeg" },
      { name: "Dr. Imam", specialization: "Neurosurgery Specialist", image: "doctor9.jpg" },
    ],
  };
   ...
   function updateTestTypes() {
        ...
        switch (scanType) {
            ...
            case "CT Scan":
                ...
                addOption(testTypeSelect, "CT Scan Arthrography", "CT Scan Arhtrography ");
            ...
            case "UltraSound Scan":
                ...
                addOption(testTypeSelect, "Transvaginal ultrasound", "Transvaginal ultrasound");
